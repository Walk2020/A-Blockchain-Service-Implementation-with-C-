...
#define TCP_MAIN_SERVER_PORT_NUM 25128 //port number of main server
...
int main(int argc, char *argv[]){
    ...
    //create a TCP socket of clientA
    ...
    if((argc == 2) && (strcmp(argv[1], "TXLIST") == 0)){
        //get transfer list
        cout << "ClinetA sent a sorted list request to the main server." << endl;
